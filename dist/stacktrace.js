...
exports.JavaStackTrace = {
            ...
            if (inTrace) {
                ...
                if (more) { //is <... 1 more> like
                    ...
                    if (trace) {
                        ...
                        if (inRoot && currentStack)
                            currentStack.trace.push(singleTrace);
                        else if (currentSubStack)
                            currentSubStack.trace.push(singleTrace);
                        continue;
                    }
                    else {
                        if (currentSubStack && currentStack)
                            currentStack.subException.push(currentSubStack);
                        currentSubStack = null;
                    }
                }
    ...
    parseFirst: (data) => exports.JavaStackTrace.parse(data)[0]
};
